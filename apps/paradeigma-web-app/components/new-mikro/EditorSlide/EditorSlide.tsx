                ...
                <S.FieldsContainer>
                    <S.FormControl>
                        ...
                        <InputLabel sx={{ textIndent: '0.5rem' }}>
                            <TungstenOutlinedIcon /> Name it like a variable: Keep it short, but self-explanatory.
                        </InputLabel>
                    </S.FormControl>
                    <S.FormControl>
                        <Input
                        ...
                        />
                        <InputLabel sx={{ textIndent: '0.5rem' }}>
                            <TungstenOutlinedIcon /> As with good docs, a complete description is always appreciated.
                        </InputLabel>
                    </S.FormControl>
