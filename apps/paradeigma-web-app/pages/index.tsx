...
const HomePage: NextPage = () => (
    <>
        <PixelSlide image={{ src: zephirImg, altText: 'Pixel Zephir', priority: true }}>
            ...
            <HighlightedText
                tooltipText={<><b><em>mīkrós</em></b>: Short and sweet code bits.</>}>
                top mikros
        ...
        <PixelSlide image={{ src: harpImg, altText: 'Pixel harp' }}>
            <HighlightedText
                tooltipText={<><b><em>parádeigma</em></b>: Illustrative pattern, example.</>}>
                Why Paradeigma?
            </HighlightedText> Because documentation is often not enough to understand a{' '} 
            coding concept. We need real-life use cases, <HighlightedText>insightful bits
            </HighlightedText> of true code.
        </PixelSlide>
    </>
);
